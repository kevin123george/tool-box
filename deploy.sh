...
for script in stock_fetcher.py stock_history_fetcher.py stock_daemon.py fundamentals_fetcher.py market_data_fetcher.py stock_api.py fx_fetcher.py n26_parser.py tr_parser.py; do
