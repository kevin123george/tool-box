...
def search_tickers(query):
    """Search for tickers by name/symbol using yfinance Search API."""
    allowed_types = {"EQUITY", "ETF"}
    results = []

    # Try yfinance Search class first (yfinance >= 0.2.38)
    try:
    ...
    # Fallback: raw Yahoo Finance search with browser-like headers
